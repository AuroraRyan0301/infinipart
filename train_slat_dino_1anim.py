#!/usr/bin/env python3
"""SLat module + DINOv2 4-frame overfit: table 22367 basic_2 vs basic_5."""
...
DINO_ROOT = "/mnt/data_ssd/infinigen-sim-data/encoded_dino/PhysXMobility"

device = torch.device("cuda:0")
torch.manual_seed(42)
wandb.init(project="infinipart", name="slat_dino_table_1anim", config={"samples": ["basic_2"], "lr": 1e-4, "steps": 5000})
...
out_dir = os.path.join(DATA_ROOT, "checkpoints/slat_dino_1anim")
...
print(f"\nSLat + DINOv2 overfit: basic_2 vs basic_5, {total_steps} steps\n", flush=True)
