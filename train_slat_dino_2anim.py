...
wandb.init(project="infinipart", name="slat_dino_2anim", config={"samples": ["basic_2", "basic_5"], "lr": 1e-4, "steps": 30000})
...
out_dir = os.path.join(DATA_ROOT, "checkpoints/slat_dino_2anim")
